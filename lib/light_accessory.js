  ...
  getSendParam(name, value) {
    ...
    switch (name) {
      case Characteristic.On:
        ...
        value = isOn;
        this.log.info(`[%s] current power state is  [%s].`, this.homebridgeAccessory.displayName, value);
        break;
      case Characteristic.ColorTemperature:
        ...
        value = temperature;
        this.log.info(`[%s] current color temperature [%s].`, this.homebridgeAccessory.displayName, value);
        break;
      case Characteristic.Brightness:
        {
          ...
          this.log.info(`[%s] current brightness [%s].`, this.homebridgeAccessory.displayName, value);
        }
        break;
    ...
    this.log.info(`[%s] current hue [%s].`, this.homebridgeAccessory.displayName, value);
  }
